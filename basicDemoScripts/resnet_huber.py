...
autoencoder.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=1e-4), loss = 'huber_loss', run_eagerly=True, metrics=['accuracy'])
autoencoder.summary()
##=========================================================================================================================================
...
plot_loss_accuracy(history); plt.show(); plt.savefig('./outputs/lossAccuracyPlot_huber.jpg')
compare_loss_accuracy(history); plt.show(); plt.savefig('./outputs/compareLossAccuracyPlot_huber.jpg')
autoencoder.save('./outputs/huber_model.h5')
...
plt.savefig('./outputs/huber_testcase.jpg', pad_inches=0.01)
